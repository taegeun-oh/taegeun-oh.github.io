...
const areas = [
  ...
  { id: "image-quality", number: "04", title: "Image quality & visual signal processing", summary: "No-reference methods for sharpness, motion blur, visual quality, and robust content fingerprints—rooted in Taegeun Oh’s doctoral research.", topics: ["Blind sharpness prediction", "Motion-blur assessment", "Visual quality adaptation", "Content fingerprinting"], image: "/research-image-quality-v2.webp", alt: "Scientific diagram of camera-shake analysis, spectral features, and no-reference image quality assessment" },
];
